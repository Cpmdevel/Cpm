...
⠀     ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠠⠒⠉⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠉⠛⠤⡀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
           ...
           ╚══════╝╚══════╝╚═╝░░╚══╝╚═╝░░░╚═╝░░░╚═╝░░╚═╝
                    ...
                    𝐂𝐀𝐑 𝐏𝐀𝐑𝐊𝐈𝐍𝐆 𝐌𝐔𝐋𝐓𝐈𝐏𝐋𝐀𝐘𝐄𝐑 𝟏

                     𝙋𝙍𝙀𝙎𝙎 𝙀𝙉𝙏𝙀𝙍 𝙏𝙊 𝘾𝙊𝙉𝙏𝙄𝙉𝙐𝙀                                 
...
from grindsociety import Zenxcpm
...
def banner(console):
    ...
    brand_name = figlet_format('CPMDEVEL', font='bloody')
...
def load_player_data(cpm):
    ...
    if response.get('ok'):
        ...
        if 'floats' in data and 'localID' in data and 'money' in data and 'coin' in data:
            ...
            print(Colorate.Horizontal(Colors.rainbow, '==========[ PERSONAL DETAILS ]=========='))
...
def load_client_details():
    ...
    print(Colorate.Horizontal(Colors.rainbow, '===============[ TERMUX MENU ]==============='))
